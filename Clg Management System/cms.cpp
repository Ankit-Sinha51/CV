...
struct student
{
    ...
    string semester;//for semester info
                        ...
                        {  
                            ...
                            for( i=0;choice!='n';i++)
                            {
                                ...
                                if((choice=='y')||(choice=='Y')||(choice=='1'))
                                {
                                    ...
                                    cout<<"Enter Semester: ";
                                    cin>>studentData.semester;
                                    cout<<"Enter Branch: ";
                                    cin>>studentData.branch;
 
                                    f1<<studentData.fname<<endl<<studentData.lname<<endl<<studentData.Registration<<endl<<studentData.semester<<endl<<studentData.branch<<endl;
                        ...
                        {  
                            ...
                            { 
                                ...
                                if(studentData.fname==find)
                                {
                                    ...
                                    getline(f2,studentData.semester);
                                    cout<<"Class: "<<studentData.semester<<endl;
                                    getline(f2,studentData.branch);
                                    cout<<"Branch: "<<studentData.branch<<endl<<endl;
                                }
                        ...
                        { 
                            ...
                            for(i=0;choice!='n'&& choice!='N';i++)
                            {
                                ...
                                if((choice=='y')||(choice=='Y')||(choice=='1'))
                                {
                                    ...
                                    cin>>tech[i].serves;
                                    cout<<"Enter The Subject teached: ";
                                    cin>>tech[i].subj;
